/**
 * Test file for Job: examplejob
 */

var assert = require ('assert');
var examplejob_SUT = require('../examplejob');

var mockedConfig, mockedDependencies;

describe ('examplejob test', function(){
  ...
  describe ('http request example tests', function(){
    it('should handle server errors', function (done){
      ...
      var config = {};
      examplejob_SUT.onRun(config, mockedDependencies, function(err, data){
